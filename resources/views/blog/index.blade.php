        ...
        <div class="row row-col-gap" data-gutter="20">
            ...
            <div class="theme-blog-item _br-2 theme-blog-item-center">
              ...
              <div class="banner _h-45vh  banner-">
                ...
                <div class="banner-caption banner-caption-bottom banner-caption-grad">
                  ...
                  <p class="theme-blog-item-desc">Et fringilla nunc a vivamus ac accumsan sagittis ligula quam</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-3 ">
            <div class="theme-blog-item _br-2 theme-blog-item-center">
              <a class="theme-blog-item-link" href="blog-post.html"></a>
              <div class="banner _h-45vh  banner-">
                <div class="banner-bg" style="background-image:url(./img/730x435.png);"></div>
                <div class="banner-caption banner-caption-bottom banner-caption-grad">
                  <p class="theme-blog-item-time">3 days ago</p>
                  <h5 class="theme-blog-item-title">Canada: forest trip</h5>
                  <p class="theme-blog-item-desc">Nam dictum lacus fermentum sapien magna parturient nunc maecenas mattis</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="theme-blog-item _br-2 theme-blog-item-center theme-blog-item-white">
              ...
              <div class="banner _h-45vh  banner-">
                ...
                <div class="banner-caption banner-caption-bottom banner-caption-">
                  ...
                  <p class="theme-blog-item-desc">Purus fermentum suspendisse malesuada sapien gravida aliquam metus in odio</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="theme-blog-item _br-2 theme-blog-item-center">
              ...
              <div class="banner _h-45vh  banner-">
                ...
                <div class="banner-caption banner-caption-bottom banner-caption-grad">
                  ...
                  <p class="theme-blog-item-desc">Molestie penatibus vestibulum cursus penatibus vehicula dapibus pharetra pulvinar nunc</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="theme-blog-item _br-2 theme-blog-item-center">
              ...
              <div class="banner _h-45vh  banner-">
                ...
                <div class="banner-caption banner-caption-bottom banner-caption-grad">
                  ...
                  <p class="theme-blog-item-desc">Lacus facilisis sem suspendisse nullam non habitasse etiam elit sodales</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-7 ">
            <div class="theme-blog-item _br-2 theme-blog-item-center theme-blog-item-white">
              <a class="theme-blog-item-link" href="blog-post.html"></a>
              <div class="banner _h-45vh  banner-">
                <div class="banner-bg" style="background-image:url(./img/730x260.png);"></div>
                <div class="banner-caption banner-caption-bottom banner-caption-">
                  <p class="theme-blog-item-time">3 weeks ago</p>
                  <h5 class="theme-blog-item-title">Where East Coasters should go this summer</h5>
                  <p class="theme-blog-item-desc">Sagittis volutpat cursus parturient magna velit vulputate mi maecenas imperdiet</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="theme-blog-item _br-2 theme-blog-item-center theme-blog-item-white">
              ...
              <div class="banner _h-45vh  banner-">
                ...
                <div class="banner-caption banner-caption-bottom banner-caption-">
                  ...
                  <p class="theme-blog-item-desc">Cursus ad ante cras dictumst praesent bibendum hac inceptos senectus</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="theme-blog-item _br-2 theme-blog-item-center">
              ...
              <div class="banner _h-45vh  banner-">
                ...
                <div class="banner-caption banner-caption-bottom banner-caption-grad">
                  ...
                  <p class="theme-blog-item-desc">Volutpat sit conubia sed platea quam ipsum amet aliquam pellentesque</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4 ">
            <div class="theme-blog-item _br-2 theme-blog-item-center">
              ...
              <div class="banner _h-45vh  banner-">
                ...
                <div class="banner-caption banner-caption-bottom banner-caption-grad">
                  <p class="theme-blog-item-time">mounth ago</p>
                  <h5 class="theme-blog-item-title">New York Experiences</h5>
                  <p class="theme-blog-item-desc">Tincidunt sit parturient ante luctus cum accumsan luctus pharetra malesuada</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="theme-footer-section theme-footer-">
              ...
              <div class="theme-footer-brand-text">
                <p>Taciti sodales metus ultrices vivamus posuere odio at at aliquet tincidunt arcu taciti ad taciti</p>
                <p>Mus ridiculus eu nisl sed vehicula magna nunc nisl montes consectetur quam mus nibh lacus</p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
